...
const OrderDetailScreen = ({ products, createdAt }) => {
   ...
   return (
      <ScrollView style={{ backgroundColor: '#ffffff' }}>
         ...
         <View
            style={{ padding: 12, height: '100%', backgroundColor: '#ffffff' }}
         >
            ...
            <View style={styles.fulfillmentContainer}>
               ...
               <Text style={styles.fulfillmentInfo}>
                  ...
                  {'-'}
                  {moment(carts[0]?.fulfillmentInfo?.slot?.to).format('HH:mm')}
                  {')'}
               </Text>
            </View>
            <View style={styles.paymentDetails}>
               ...
               <Text>{carts[0].availablePaymentOption?.label || 'N/A'}</Text>
            </View>
